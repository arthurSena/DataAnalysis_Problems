...
Observando os dados, notamos que os mesmos se encontram organizados por disciplinas, onde cada linha tem a média do aluno em uma determinada matéria. Ainda sim, podemos criar um modelo a partir desses dados e verificar o seu desempenho. As variáveis que eu achei que possam ter uma maior influência na evasõa foram:
...
Agora, nós usaremosa biblioteca C50 para construir a árvore de classificação.
